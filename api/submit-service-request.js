  ...
  try {
    ...
    const serviceDetails = {
      ...
      custom_trip: {
        ...
        hotel_rooms_or_suites: clean(body.custom_hotel_rooms) || clean(body.hotel_rooms_or_suites) || null,
        bedrooms: clean(body.custom_bedrooms) || clean(body.lodging_bedrooms) || null,
        bathrooms: clean(body.custom_bathrooms) || clean(body.lodging_bathrooms) || null,
